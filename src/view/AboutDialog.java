...
public class AboutDialog extends JDialog {
	...
	public AboutDialog(JFrame parent) {
		super(parent, "Anonimity - About", true);
		...
		JLabel label = new JLabel("Anonimity - Experiments ");
		label.setFont(fontappname);

		center.add(label);
		center.add(new JLabel("Version 0.1"));
		center.add(new JLabel("Rafael Caballero - 2016"));
